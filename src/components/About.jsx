...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 px-8 min-h-[90vh] bg-gradient-to-b from-[#131927] to-[#141733] border-y border-gray-800">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-[#19213a] rounded-2xl p-7 shadow-lg">
              <h3 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">My Journey</h3>
          ...
          <div className="space-y-8">
            <div className="bg-[#19213a] rounded-2xl p-7 shadow-lg">
              <h3 className="text-2xl font-semibold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Tech Stack</h3>
            ...
            {/* Skills */}
            <div className="bg-[#19213a] rounded-2xl p-7 shadow-lg">
              <h3 className="text-2xl font-semibold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">What I Do</h3>
